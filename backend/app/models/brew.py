...
class Brew(Base):
    ...
    bean_id: Mapped[int] = mapped_column(Integer, ForeignKey("beans.id", ondelete="SET NULL"))
    brewed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=datetime.utcnow)
